...
Both height and weight are positively correlated with age. As age increases, so does height/weight. The slope of the regression line for weight is not quite as steep as it is for height. Logically, this makes sense. 
...
```
Height, weight, and age seem to have normal distributions, though zombies killed and years of education do not. These may be Bernoulli or Poisson distributions. 
